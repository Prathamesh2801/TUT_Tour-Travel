...
export default function hero2() {
  ...
  <div className='flex flex-col justify-center col-start-4 col-end-2'>
          <div className=' '>
          <h1 className='text-4xl font-bold flex text-white mb-4 '>   Passionate Travelling, <br /> Memorable Experiences</h1>
             <p className="text-gray-300 mb-6">
            We always have and always will strive to protect people, life-enr
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat, corrupti asperiores. Cumque mollitia nesciunt in consequuntur quis numquam, laudantium ullam pariatur fuga obcaecati quo culpa harum totam quisquam expedita! Excepturi!bb Lorem ipsum dolor sit amet consectetur adipisicing elit. Et quisquam rerum deserunt vel eveniet quia? Aspernatur amet corporis iste quam eveniet ducimus, consequatur culpa laboriosam quisquam minima rem non odit?iching travel
            experiences, and the planet. We believe that travel can empower and leave behind
            lasting positive impacts.
          </p>
             <button className="bg-orange-400 hover:bg-orange-500 text-black font-semibold px-6 py-2 rounded-full w-fit">
            Read More
          </button>                            </div>
        </div>
