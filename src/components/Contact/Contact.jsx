   ...
   <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
        <div className="grid lg:grid-cols-2 grid-cols-1  gap-5 ">
            <div className="lg:mb-0 mb-10 z-10">
                <div className="group w-full h-full">
                    <div className="relative h-full">
                        <img src="https://media.istockphoto.com/id/497038029/photo/travel.jpg?b=1&s=612x612&w=0&k=20&c=kOt4_Xi2e8TenkX5hPIwA3xhqP354b8cI3CyR_Edqv8=" alt="ContactUs tailwind section" className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700 object-cover"/>
                        <h1 className="font-manrope text-white text-4xl font-bold leading-10 absolute top-5 left-11">Contact us</h1>
                        <div className="absolute bottom-0 w-full lg:p-11 p-5">
                            <div className=" rounded-lg p-6 block">
                                <a href="javascript:;" className="flex items-center mb-6">
                                    ...
                                    <h5 className="text-black text-base font-normal leading-6 ml-5">1234567890</h5>
                                </a>
                                <a href="javascript:;" className="flex items-center mb-6">
                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 className="text-black text-base font-normal leading-6 ml-5">apnaproject23@gmail.com</h5>
                                </a>
            ...
            <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl  z-20">
